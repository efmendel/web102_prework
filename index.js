...
const displayStr = `A total of $${totalRaised} has been raised for 11 games. Currently, ${totalUnfundedGames < 2 ? "1 game remains" : totalUnfundedGames + " games remain"} unfunded. We need your help to fund these amazing games!`
